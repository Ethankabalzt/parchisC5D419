...
public class GUIPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnJugar, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 230, 350, 100));
        ...
        getContentPane().add(btnHistoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 550, -1, -1));

        btnSalir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/botonSalir.png"))); // NOI18N
        btnSalir.setActionCommand("Salir");
        btnSalir.setBorderPainted(false);
        btnSalir.setContentAreaFilled(false);
        getContentPane().add(btnSalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 670, 170, 50));
        ...
        getContentPane().add(btnSonido, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 650, -1, -1));

        jlFondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/fondoPrincipal.png"))); // NOI18N
        getContentPane().add(jlFondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 960, -1));
